        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img src="{{ asset('storage/'.$superadmin->image) }}" class="rounded-circle" style="max-width: 50%;" />
                    @else
                    <img src="{{ asset('images/preview.png') }}" class="rounded-circle" style="max-width: 50%;" />
                    @endif
                    <h2>{{$superadmin->name}}</h2>
                    <h3>{{$superadmin->user->role}}</h3>
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">{{$superadmin->name}}</div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Username</div>
                                <div class="col-lg-9 col-md-8">{{$superadmin->user->username}}</div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Jabatan</div>
                                <div class="col-lg-9 col-md-8">{{$superadmin->user->role}}</div>
                            </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="username" type="text" class="form-control" id="username"
                                            value="{{$superadmin->user->username}}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="role" type="text" class="form-control" id="role"
                                            value="{{$superadmin->user->role}}" readonly>
                                    </div>
                                </div>
