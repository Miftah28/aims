...
<div class="pagetitle">
    <h1>Edit Data Tempat Penjemputan</h1>
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Data Tempat Penjemputan</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit Data Tempat Penjemputan</h5>
                    <!-- Browser Default Validation -->
                    <form class="row g-3" method="POST"
                        action="{{ route('Admin.manajemen-sampah.kelola-tempat.update', Crypt::encrypt($tempat->id)) }}"
                                        ...
                                        <div class="row justify-content-start">
                                            ...
                                            <div class="col-12 mb-3">
                                                <label for="tempat" class="form-label"><span
                                                    ...
                                                    Alamat</label>
                                                <textarea id="tempat" type="text" class="form-control"
                                                    name="tempat">{{$tempat->tempat}}</textarea>
                                            </div>
                                            <div class="col-12 mb-3">
                                                ...
                                                <input id="koordinat" type="text" class="form-control" name="koordinat"
                                                    value="{{$tempat->koordinat}}">
                                            </div>
                                            <div class="col-6 mb-3">
                                                <label for="longitude" class="form-label"><span
                                                        style="color: red;">*</span>
                                                    Longitude</label>
                                                <input id="longitude" type="text" class="form-control" name="longitude" value="{{$tempat->koordinat}}">
                                            </div>
                                            <div class="col-6 mb-3">
                                                <label for="latitude" class="form-label"><span
                                                        style="color: red;">*</span>
                                                    Latitude</label>
                                                <input id="latitude" type="text" class="form-control" name="latitude" value="{{$tempat->koordinat}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
