                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-12 mb-3">
                                <label for="lokasi_id" class="form-label"><span style="color: red;">*</span> Dinas</label>
                                <select class="selectpicker"  data-live-search="true" name="lokasi_id" id="lokasi_id-create"
                                    required>
