    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('Admin.laporan.pemasukan-sampah.cetak', Crypt::encrypt(Auth::user()->admin->id)) }}"
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            ...
                            <div class="col-12 mb-3" id="lokasi-container">
                                <label for="lokasi" class="form-label">Lokasi</label>
                                <select id="lokasi" class="selectpicker" multiple data-live-search="true" data-width="100%" name="lokasi[]">
                                    <option value="">Pilih Petugas </option>
