    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Penambahan Akun Petugas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{ route('Admin.master.akun-petugas.store') }}"
                        ...
                        <div class="row justify-content-start">
                            <div class="col-12 mb-3">
                                ...
                                <input id="instansi" type="text" class="form-control" name="instansi"
                                    value="{{dataadmin(Auth::user()->id) ? dataadmin(Auth::user()->id)->instansi :'Tidak ada instansi'}}" disabled>
                            </div>
...
<div class="modal fade" id="edit{{$akuns->id}}" tabindex="-1" data-bs-backdrop="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('Admin.master.akun-petugas.update', Crypt::encrypt($akuns->id)) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-12 mb-3">
                                <label for="instansi" class="form-label"><span style="color: red;">*</span>
                                    instansi</label>
                                <input id="instansi" type="text" class="form-control" name="instansi"
                                    value="{{ $akuns->admin->instansi }}" disabled>
                            </div>
                            <div class="col-12 mb-3">
                            ...
                            <div class="col-12 mb-3">
                                <label for="name" class="form-label"><span style="color: red;">*</span>
                                    Nama Lengkap</label>
                                <input id="name" type="text" class="form-control" name="name" value="{{ $akuns->name }}">
                            </div>
                        </div>
                        <div class="row justify-content-start">
                            <div class="col-6 mb-3">
...
<div class="modal fade" id="delete{{ $akuns->id }}" tabindex="-1" data-bs-backdrop="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('Admin.master.akun-petugas.destroy', Crypt::encrypt($akuns->id)) }}">
                    @csrf
                    @method('DELETE')
